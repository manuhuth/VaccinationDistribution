...
def get_extension() -> Extension:
    ...
    sources = [os.path.join("swig", "tmp_akih_pn.i"), *get_model_sources()]
    ...
    # Build shared object
    ext = Extension(
        'tmp_akih_pn._tmp_akih_pn',
        sources=sources,
        include_dirs=ext_include_dirs,
        libraries=libraries,
        library_dirs=ext_library_dirs,
        swig_opts=[
            '-c++', '-modern', '-outdir', 'tmp_akih_pn',
...
setup(
    ...
    cmdclass=CMDCLASS,
    version='0.1.0',
    description='AMICI-generated module for model tmp_akih_pn',
