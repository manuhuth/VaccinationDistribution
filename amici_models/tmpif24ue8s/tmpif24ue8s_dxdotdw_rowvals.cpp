...
static constexpr std::array<int, 232> dxdotdw_rowvals_tmpif24ue8s_ = {
...
void dxdotdw_rowvals_tmpif24ue8s(sunindextype *rowvals){
    std::copy(dxdotdw_rowvals_tmpif24ue8s_.begin(), dxdotdw_rowvals_tmpif24ue8s_.end(), rowvals);
}
} // namespace amici
} // namespace model_tmpif24ue8s