...
/*-----------------------------------------------
              @(target):= _vaccination_piecewise.so
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__vaccination_piecewise

#else
#  define SWIG_init    init_vaccination_piecewise

#endif
#define SWIG_name    "_vaccination_piecewise"
