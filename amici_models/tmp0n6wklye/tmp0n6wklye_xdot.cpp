...
#include "tmp0n6wklye_xdot.h"

namespace amici {
namespace model_tmp0n6wklye {

void xdot_tmp0n6wklye(realtype *xdot, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w){
