"""AMICI-generated module for model model_steadystate"""

import amici

# Ensure we are binary-compatible, see #556
if '0.11.16' != amici.__version__:
    raise RuntimeError('Cannot use model model_steadystate, generated with AMICI '
...
from model_steadystate._model_steadystate import *
