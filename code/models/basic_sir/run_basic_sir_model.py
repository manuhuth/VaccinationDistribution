...
path = 'stored_models/basic_sir/basic_sir'
S_0 = 1000
I_0 = 0.000001

model_basic_sir_create_sbml(path=path, S_0=S_0, I_0=I_0, R_0=0)
model_and_solver = get_model_and_solver_from_sbml(path_sbml=path, model_name='basic_sir',
