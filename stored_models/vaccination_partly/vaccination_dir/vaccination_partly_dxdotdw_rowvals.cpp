...
static constexpr std::array<sunindextype, 216> dxdotdw_rowvals_vaccination_partly_ = {
...
void dxdotdw_rowvals_vaccination_partly(SUNMatrixWrapper &dxdotdw){
    dxdotdw.set_indexvals(gsl::make_span(dxdotdw_rowvals_vaccination_partly_));
}
} // namespace model_vaccination_partly
} // namespace amici
