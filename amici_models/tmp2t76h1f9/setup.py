...
def get_extension() -> Extension:
    ...
    sources = [os.path.join("swig", "tmp2t76h1f9.i"), *get_model_sources()]
    ...
    # Build shared object
    ext = Extension(
        'tmp2t76h1f9._tmp2t76h1f9',
        sources=sources,
        include_dirs=ext_include_dirs,
        libraries=libraries,
        library_dirs=ext_library_dirs,
        swig_opts=[
            '-c++', '-modern', '-outdir', 'tmp2t76h1f9',
...
setup(
    ...
    cmdclass=CMDCLASS,
    version='0.1.0',
    description='AMICI-generated module for model tmp2t76h1f9',
