...
void dJydsigmay_vaccination(realtype *dJydsigmay, const int iy, const realtype *p, const realtype *k, const realtype *y, const realtype *sigmay, const realtype *my){
    switch(iy) {
        ...
        case 7:
            ...
            break;
        case 8:
            dJydsigmay[8] = 1.0/sigmaobservable_spline_countryA_vac1 - 1.0*std::pow(-mobservable_spline_countryA_vac1 + observable_spline_countryA_vac1, 2)/std::pow(sigmaobservable_spline_countryA_vac1, 3);
            break;
        case 9:
            dJydsigmay[9] = 1.0/sigmaobservable_spline_countryA_vac2 - 1.0*std::pow(-mobservable_spline_countryA_vac2 + observable_spline_countryA_vac2, 2)/std::pow(sigmaobservable_spline_countryA_vac2, 3);
            break;
        case 10:
            dJydsigmay[10] = 1.0/sigmaobservable_quantity_countryA_vac1 - 1.0*std::pow(-mobservable_quantity_countryA_vac1 + observable_quantity_countryA_vac1, 2)/std::pow(sigmaobservable_quantity_countryA_vac1, 3);
            break;
        case 11:
            dJydsigmay[11] = 1.0/sigmaobservable_quantity_countryA_vac2 - 1.0*std::pow(-mobservable_quantity_countryA_vac2 + observable_quantity_countryA_vac2, 2)/std::pow(sigmaobservable_quantity_countryA_vac2, 3);
            break;
        case 12:
            dJydsigmay[12] = 1.0/sigmaobservable_quantity_countryB_vac1 - 1.0*std::pow(-mobservable_quantity_countryB_vac1 + observable_quantity_countryB_vac1, 2)/std::pow(sigmaobservable_quantity_countryB_vac1, 3);
            break;
        case 13:
            dJydsigmay[13] = 1.0/sigmaobservable_quantity_countryB_vac2 - 1.0*std::pow(-mobservable_quantity_countryB_vac2 + observable_quantity_countryB_vac2, 2)/std::pow(sigmaobservable_quantity_countryB_vac2, 3);
            break;
    }
}
