...
void Jy_vaccination(realtype *Jy, const int iy, const realtype *p, const realtype *k, const realtype *y, const realtype *sigmay, const realtype *my){
    switch(iy) {
        ...
        case 46:
            ...
            break;
        case 47:
            Jy[0] = 0.5*std::log(2*amici::pi*std::pow(sigma_ynumber_vac1, 2)) + 0.5*std::pow(-mynumber_vac1 + ynumber_vac1, 2)/std::pow(sigma_ynumber_vac1, 2);
            break;
        case 48:
            Jy[0] = 0.5*std::log(2*amici::pi*std::pow(sigma_ynumber_vac2, 2)) + 0.5*std::pow(-mynumber_vac2 + ynumber_vac2, 2)/std::pow(sigma_ynumber_vac2, 2);
            break;
        case 49:
