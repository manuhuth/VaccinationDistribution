...
def model_basic_sir_create_sbml(path, S_0, I_0, R_0=0):
    ...
    species = {
        "susceptible": {"compartment": "A", "initial_amount": S_0},
        "infectious": {"compartment": "A", "initial_amount": I_0},
        "recovered": {"compartment": "A", "initial_amount": R_0},
    }

    parameters = {"beta": {"value": 1}, "gamma": {"value": 0.13}}

    infection_reaction = {
        "reactants": {"susceptible": 1, "infectious": 1},
    ...
    recover_reaction = {
        "reactants": {"infectious": 1},
        "products": {"recovered": 1},
        "formula": "gamma * infectious",
    }

    reactions = {"infection": infection_reaction, "recover": recover_reaction}
