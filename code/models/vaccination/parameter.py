...
def general_set_up():
    ...
    distances = np.array([[0, 999], [999, 0]])
...
def parameters_vaccine_one():
    parameter = {
        "omega_vac1_virW": 0.9,  # if 1, vaccine1 gives full death protection against wild type if infected
        "delta_vac1_virW": 0.8,  # if 1, vaccine1 gives full infection protection against wild type
...
def parameters_vaccine_two():
    parameter = {
        ...
        "omega_vac2_virM": 0.9,  # if 1, vaccine2 gives full death protection against mutant type if infected
        "delta_vac2_virM": 0.8,  # if 1, vaccine2 gives full infection protection against mutant type
    }
...
def start_parameter_one():
    parameter = {
        "susceptible_countryA_vac0_t0": 8000000,
        "susceptible_countryB_vac0_t0": 8000000,
