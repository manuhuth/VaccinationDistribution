...
static constexpr std::array<int, 232> dxdotdw_rowvals_vaccination_neural_network_ = {
...
void dxdotdw_rowvals_vaccination_neural_network(sunindextype *rowvals){
    std::copy(dxdotdw_rowvals_vaccination_neural_network_.begin(), dxdotdw_rowvals_vaccination_neural_network_.end(), rowvals);
}
} // namespace amici
} // namespace model_vaccination_neural_network