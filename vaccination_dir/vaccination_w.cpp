...
void w_vaccination(realtype *w, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *tcl, const realtype *spl){
    w[0] = spl_0;
    w[1] = spl_1;
    w[2] = infectious_countryA_vac0_virW*lambda1*(1 - amici_p);
    w[3] = amici_p*infectious_countryA_vac0_virW*lambda1;
    w[4] = infectious_countryA_vac0_virM*lambda1*(1 - amici_p);
    w[5] = amici_p*infectious_countryA_vac0_virM*lambda1;
    w[6] = infectious_countryA_vac1_virW*lambda1*(-amici_p*(1 - omega_vac1_virW) + 1);
    w[7] = amici_p*infectious_countryA_vac1_virW*lambda1*(1 - omega_vac1_virW);
    w[8] = infectious_countryA_vac1_virM*lambda1*(-amici_p*(1 - omega_vac1_virM) + 1);
    w[9] = amici_p*infectious_countryA_vac1_virM*lambda1*(1 - omega_vac1_virM);
    w[10] = infectious_countryA_vac2_virW*lambda1*(-amici_p*(1 - omega_vac2_virW) + 1);
    w[11] = amici_p*infectious_countryA_vac2_virW*lambda1*(1 - omega_vac2_virW);
    w[12] = infectious_countryA_vac2_virM*lambda1*(-amici_p*(1 - omega_vac2_virM) + 1);
    w[13] = amici_p*infectious_countryA_vac2_virM*lambda1*(1 - omega_vac2_virM);
    w[14] = infectious_countryB_vac0_virW*lambda1*(1 - amici_p);
    w[15] = amici_p*infectious_countryB_vac0_virW*lambda1;
    w[16] = infectious_countryB_vac0_virM*lambda1*(1 - amici_p);
    w[17] = amici_p*infectious_countryB_vac0_virM*lambda1;
    w[18] = infectious_countryB_vac1_virW*lambda1*(-amici_p*(1 - omega_vac1_virW) + 1);
    w[19] = amici_p*infectious_countryB_vac1_virW*lambda1*(1 - omega_vac1_virW);
    w[20] = infectious_countryB_vac1_virM*lambda1*(-amici_p*(1 - omega_vac1_virM) + 1);
    w[21] = amici_p*infectious_countryB_vac1_virM*lambda1*(1 - omega_vac1_virM);
    w[22] = infectious_countryB_vac2_virW*lambda1*(-amici_p*(1 - omega_vac2_virW) + 1);
    w[23] = amici_p*infectious_countryB_vac2_virW*lambda1*(1 - omega_vac2_virW);
    w[24] = infectious_countryB_vac2_virM*lambda1*(-amici_p*(1 - omega_vac2_virM) + 1);
    w[25] = amici_p*infectious_countryB_vac2_virM*lambda1*(1 - omega_vac2_virM);
...
: (
   0
)))))))))))/((1 + std::pow(exponentiale, -spl_0))*(infectious_countryA_vac0_virM + infectious_countryA_vac0_virW + recovered_countryA_vac0_virM + recovered_countryA_vac0_virW + 2*susceptible_countryA_vac0));
...
: (
   0
)))))))))))/((1 + std::pow(exponentiale, -spl_1))*(infectious_countryA_vac0_virM + infectious_countryA_vac0_virW + recovered_countryA_vac0_virM + recovered_countryA_vac0_virW + 2*susceptible_countryA_vac0));
    w[100] = susceptible_countryB_vac0*(1 - 1/(1 + std::pow(exponentiale, -spl_0)))*((t >= xx0 && t < xx1) ? (
   vaccine_supply_par_vac1_xx0
)
: ((t >= xx1 && t < xx2) ? (
   vaccine_supply_par_vac1_xx1
...
: (
   0
)))))))))))/(infectious_countryB_vac0_virM + infectious_countryB_vac0_virW + recovered_countryB_vac0_virM + recovered_countryB_vac0_virW + 2*susceptible_countryB_vac0);
    w[101] = susceptible_countryB_vac0*(1 - 1/(1 + std::pow(exponentiale, -spl_1)))*((t >= xx0 && t < xx1) ? (
   vaccine_supply_par_vac2_xx0
)
: ((t >= xx1 && t < xx2) ? (
   vaccine_supply_par_vac2_xx1
...
: (
   0
    ...
    w[106] = infectious_countryB_vac0_virW*(1 - 1/(1 + std::pow(exponentiale, -spl_0)))*((t >= xx0 && t < xx1) ? (
   vaccine_supply_par_vac1_xx0
)
: ((t >= xx1 && t < xx2) ? (
   vaccine_supply_par_vac1_xx1
...
: (
   0
    ...
    w[107] = infectious_countryB_vac0_virW*(1 - 1/(1 + std::pow(exponentiale, -spl_1)))*((t >= xx0 && t < xx1) ? (
   vaccine_supply_par_vac2_xx0
)
: ((t >= xx1 && t < xx2) ? (
   vaccine_supply_par_vac2_xx1
...
: (
   0
    ...
    w[108] = infectious_countryB_vac0_virM*(1 - 1/(1 + std::pow(exponentiale, -spl_0)))*((t >= xx0 && t < xx1) ? (
   vaccine_supply_par_vac1_xx0
)
: ((t >= xx1 && t < xx2) ? (
   vaccine_supply_par_vac1_xx1
...
: (
   0
    ...
    w[109] = infectious_countryB_vac0_virM*(1 - 1/(1 + std::pow(exponentiale, -spl_1)))*((t >= xx0 && t < xx1) ? (
   vaccine_supply_par_vac2_xx0
)
: ((t >= xx1 && t < xx2) ? (
   vaccine_supply_par_vac2_xx1
...
: (
   0
    ...
    w[114] = recovered_countryB_vac0_virW*(1 - 1/(1 + std::pow(exponentiale, -spl_0)))*((t >= xx0 && t < xx1) ? (
   vaccine_supply_par_vac1_xx0
)
: ((t >= xx1 && t < xx2) ? (
   vaccine_supply_par_vac1_xx1
...
: (
   0
    ...
    w[115] = recovered_countryB_vac0_virW*(1 - 1/(1 + std::pow(exponentiale, -spl_1)))*((t >= xx0 && t < xx1) ? (
   vaccine_supply_par_vac2_xx0
)
: ((t >= xx1 && t < xx2) ? (
   vaccine_supply_par_vac2_xx1
...
: (
   0
    ...
    w[116] = recovered_countryB_vac0_virM*(1 - 1/(1 + std::pow(exponentiale, -spl_0)))*((t >= xx0 && t < xx1) ? (
   vaccine_supply_par_vac1_xx0
)
: ((t >= xx1 && t < xx2) ? (
   vaccine_supply_par_vac1_xx1
...
: (
   0
    ...
    w[117] = recovered_countryB_vac0_virM*(1 - 1/(1 + std::pow(exponentiale, -spl_1)))*((t >= xx0 && t < xx1) ? (
   vaccine_supply_par_vac2_xx0
)
: ((t >= xx1 && t < xx2) ? (
   vaccine_supply_par_vac2_xx1
