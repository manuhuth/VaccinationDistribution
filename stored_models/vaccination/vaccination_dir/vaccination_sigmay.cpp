...
void sigmay_vaccination(realtype *sigmay, const realtype t, const realtype *p, const realtype *k){
    ...
    sigma_yproportion_countryB_vac1 = 1.0;  // sigmay[44]
    sigma_ynu_countryA_vac1 = 1.0;  // sigmay[45]
    sigma_ynu_countryB_vac1 = 1.0;  // sigmay[46]
    sigma_ynu_countryA_vac2 = 1.0;  // sigmay[47]
    sigma_ynu_countryB_vac2 = 1.0;  // sigmay[48]
    sigma_yspline_countryA_vac1 = 1.0;  // sigmay[49]
    sigma_ycountryA = 1.0;  // sigmay[50]
    sigma_ycountryB = 1.0;  // sigmay[51]
}
