...
def get_extension() -> Extension:
    ...
    sources = [os.path.join("swig", "tmp0n6wklye.i"), *get_model_sources()]
    ...
    # Build shared object
    ext = Extension(
        'tmp0n6wklye._tmp0n6wklye',
        sources=sources,
        include_dirs=ext_include_dirs,
        libraries=libraries,
        library_dirs=ext_library_dirs,
        swig_opts=[
            '-c++', '-modern', '-outdir', 'tmp0n6wklye',
...
setup(
    ...
    cmdclass=CMDCLASS,
    version='0.1.0',
    description='AMICI-generated module for model tmp0n6wklye',
