...
def get_extension() -> Extension:
    ...
    sources = [os.path.join("swig", "vaccination_partly.i"), *get_model_sources()]
    ...
    # Build shared object
    ext = Extension(
        "vaccination_partly._vaccination_partly",
        sources=sources,
...
# Install
setup(
    name="vaccination_partly",
    cmdclass=CMDCLASS,
    version="0.1.0",
    description="AMICI-generated module for model vaccination_partly",
