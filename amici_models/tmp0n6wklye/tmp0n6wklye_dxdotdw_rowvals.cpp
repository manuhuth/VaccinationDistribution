...
static constexpr std::array<sunindextype, 216> dxdotdw_rowvals_tmp0n6wklye_ = {
...
void dxdotdw_rowvals_tmp0n6wklye(SUNMatrixWrapper &dxdotdw){
    dxdotdw.set_indexvals(gsl::make_span(dxdotdw_rowvals_tmp0n6wklye_));
}
} // namespace model_tmp0n6wklye
} // namespace amici
