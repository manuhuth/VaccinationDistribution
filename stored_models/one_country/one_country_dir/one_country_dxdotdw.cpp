...
#include "one_country_dxdotdw.h"

namespace amici {
namespace model_one_country {

void dxdotdw_one_country(realtype *dxdotdw, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w){
