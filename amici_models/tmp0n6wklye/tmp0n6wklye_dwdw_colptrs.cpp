...
static constexpr std::array<sunindextype, 121> dwdw_colptrs_tmp0n6wklye_ = {
...
void dwdw_colptrs_tmp0n6wklye(SUNMatrixWrapper &dwdw){
    dwdw.set_indexptrs(gsl::make_span(dwdw_colptrs_tmp0n6wklye_));
}
} // namespace model_tmp0n6wklye
} // namespace amici
