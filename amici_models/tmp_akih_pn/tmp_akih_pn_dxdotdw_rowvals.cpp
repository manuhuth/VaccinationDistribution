...
static constexpr std::array<int, 232> dxdotdw_rowvals_tmp_akih_pn_ = {
...
void dxdotdw_rowvals_tmp_akih_pn(sunindextype *rowvals){
    std::copy(dxdotdw_rowvals_tmp_akih_pn_.begin(), dxdotdw_rowvals_tmp_akih_pn_.end(), rowvals);
}
} // namespace amici
} // namespace model_tmp_akih_pn