...
#include "tmp2t76h1f9_dJydy.h"

namespace amici {
namespace model_tmp2t76h1f9 {

void dJydy_tmp2t76h1f9(realtype *dJydy, const int iy, const realtype *p, const realtype *k, const realtype *y, const realtype *sigmay, const realtype *my){
    switch(iy) {
        case 0:
