...
#include "vaccination_partly_dxdotdw.h"

namespace amici {
namespace model_vaccination_partly {

void dxdotdw_vaccination_partly(realtype *dxdotdw, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w){
