...
void xdot_one_country(realtype *xdot, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w){
    ...
    xdot6 = -1.0*flux_r0 - 1.0*flux_r1 + 1.0*flux_r24 + 1.0*flux_r25 + 1.0*flux_r26 + 1.0*flux_r27 + 1.0*flux_r28 + 1.0*flux_r29;  // xdot[6]
    xdot7 = -1.0*flux_r2 - 1.0*flux_r3 + 1.0*flux_r30 + 1.0*flux_r31 + 1.0*flux_r32 + 1.0*flux_r33 + 1.0*flux_r34 + 1.0*flux_r35;  // xdot[7]
    xdot8 = 1.0*flux_r36 + 1.0*flux_r37 + 1.0*flux_r38 + 1.0*flux_r39 - 1.0*flux_r4 + 1.0*flux_r40 + 1.0*flux_r41 - 1.0*flux_r5;  // xdot[8]
    xdot9 = 1.0*flux_r42 + 1.0*flux_r43 + 1.0*flux_r44 + 1.0*flux_r45 + 1.0*flux_r46 + 1.0*flux_r47 - 1.0*flux_r6 - 1.0*flux_r7;  // xdot[9]
    xdot10 = 1.0*flux_r48 + 1.0*flux_r49 + 1.0*flux_r50 + 1.0*flux_r51 + 1.0*flux_r52 + 1.0*flux_r53 - 1.0*flux_r8 - 1.0*flux_r9;  // xdot[10]
    xdot11 = -1.0*flux_r10 - 1.0*flux_r11 + 1.0*flux_r54 + 1.0*flux_r55 + 1.0*flux_r56 + 1.0*flux_r57 + 1.0*flux_r58 + 1.0*flux_r59;  // xdot[11]
    xdot12 = -1.0*flux_r12 - 1.0*flux_r13 + 1.0*flux_r60 + 1.0*flux_r61 + 1.0*flux_r62 + 1.0*flux_r63 + 1.0*flux_r64 + 1.0*flux_r65;  // xdot[12]
    xdot13 = -1.0*flux_r14 - 1.0*flux_r15 + 1.0*flux_r66 + 1.0*flux_r67 + 1.0*flux_r68 + 1.0*flux_r69 + 1.0*flux_r70 + 1.0*flux_r71;  // xdot[13]
    xdot14 = -1.0*flux_r16 - 1.0*flux_r17 + 1.0*flux_r72 + 1.0*flux_r73 + 1.0*flux_r74 + 1.0*flux_r75 + 1.0*flux_r76 + 1.0*flux_r77;  // xdot[14]
    xdot15 = -1.0*flux_r18 - 1.0*flux_r19 + 1.0*flux_r78 + 1.0*flux_r79 + 1.0*flux_r80 + 1.0*flux_r81 + 1.0*flux_r82 + 1.0*flux_r83;  // xdot[15]
    xdot16 = -1.0*flux_r20 - 1.0*flux_r21 + 1.0*flux_r84 + 1.0*flux_r85 + 1.0*flux_r86 + 1.0*flux_r87 + 1.0*flux_r88 + 1.0*flux_r89;  // xdot[16]
    xdot17 = -1.0*flux_r22 - 1.0*flux_r23 + 1.0*flux_r90 + 1.0*flux_r91 + 1.0*flux_r92 + 1.0*flux_r93 + 1.0*flux_r94 + 1.0*flux_r95;  // xdot[17]
