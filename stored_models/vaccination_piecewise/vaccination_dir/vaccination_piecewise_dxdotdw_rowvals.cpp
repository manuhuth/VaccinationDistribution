...
static constexpr std::array<int, 232> dxdotdw_rowvals_vaccination_piecewise_ = {
...
void dxdotdw_rowvals_vaccination_piecewise(sunindextype *rowvals){
    std::copy(dxdotdw_rowvals_vaccination_piecewise_.begin(), dxdotdw_rowvals_vaccination_piecewise_.end(), rowvals);
}
} // namespace amici
} // namespace model_vaccination_piecewise