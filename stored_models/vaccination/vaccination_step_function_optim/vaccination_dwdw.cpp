...
void dwdw_vaccination(realtype *dwdw, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w, const realtype *tcl){
    ...
    dflux_r99_dnu_countryB_vac2 = susceptible_countryB_vac0;  // dwdw[9]
    dflux_r105_dnu_countryB_vac2 = recovered_countryB_vac0_virW;  // dwdw[10]
    dflux_r107_dnu_countryB_vac2 = recovered_countryB_vac0_virM;  // dwdw[11]
}
