...
plot_gridspec(
    y=y,
    time=np.array(time_points) / 7.0,
    title="Fraction of vaccine doses",
    legend_next_to_plot=True,
    legend_location="lower center",
    ylim=[0, 1.1],
    xlim=None,
...
col2 = "firebrick"
y11 = {
    "y": model_optimal["states"]["infectious_countryA_vac0_virW"] / 10 ** 6,
    "label": "Infectious wild type",
    "color": col1,
    "linestyle": "-",
}
y12 = {
    "y": model_optimal["states"]["infectious_countryA_vac0_virM"] / 10 ** 6,
...
y21 = {
    "y": model_unrestricted["states"]["infectious_countryA_vac0_virW"] / 10 ** 6,
    "label": "Infectious  wild type",
    "color": col1,
    "linestyle": "-",
}
y22 = {
    "y": model_unrestricted["states"]["infectious_countryA_vac0_virM"] / 10 ** 6,
    "label": "Infectious  mutant",
    "color": col2,
    "linestyle": "--",
}
...
y31 = {
    "y": model_optimal["states"]["infectious_countryB_vac0_virW"] / 10 ** 6,
    "label": "Infectious wild type",
    "color": col1,
    "linestyle": "-",
}
y32 = {
    "y": model_optimal["states"]["infectious_countryB_vac0_virM"] / 10 ** 6,
    "label": "Infectious mutant",
    "color": col2,
    "linestyle": "--",
}
...
y41 = {
    "y": model_unrestricted["states"]["infectious_countryB_vac0_virW"] / 10 ** 6,
    "label": "Infectious  wild type",
    "color": col1,
    "linestyle": "-",
}
y42 = {
    "y": model_unrestricted["states"]["infectious_countryB_vac0_virM"] / 10 ** 6,
    "label": "Infectious  mutant",
    "color": col2,
    "linestyle": "--",
}
...
plot_gridspec(
    y=y,
    time=np.array(time_points) / 7.0,
    title="Number of infectious individuals (in mil.)",
    legend_next_to_plot=True,
    legend_location="lower center",
    ylim=[0, 25],
    xlim=None,
...
plot_gridspec(
    y=y,
    time=np.array(time_points) / 7.0,
    title="Number of infectious and deceased individuals (in mil.)",
    legend_next_to_plot=True,
    legend_location="lower center",
    ylim=[0, 25],
    xlim=None,
