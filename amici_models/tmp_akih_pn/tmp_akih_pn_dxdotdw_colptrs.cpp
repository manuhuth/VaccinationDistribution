...
static constexpr std::array<int, 119> dxdotdw_colptrs_tmp_akih_pn_ = {
...
void dxdotdw_colptrs_tmp_akih_pn(sunindextype *colptrs){
    std::copy(dxdotdw_colptrs_tmp_akih_pn_.begin(), dxdotdw_colptrs_tmp_akih_pn_.end(), colptrs);
}
} // namespace amici
} // namespace model_tmp_akih_pn