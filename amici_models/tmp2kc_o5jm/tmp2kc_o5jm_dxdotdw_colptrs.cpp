...
static constexpr std::array<int, 119> dxdotdw_colptrs_tmp2kc_o5jm_ = {
...
void dxdotdw_colptrs_tmp2kc_o5jm(sunindextype *colptrs){
    std::copy(dxdotdw_colptrs_tmp2kc_o5jm_.begin(), dxdotdw_colptrs_tmp2kc_o5jm_.end(), colptrs);
}
} // namespace amici
} // namespace model_tmp2kc_o5jm