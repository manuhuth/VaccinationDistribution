...
void sigmay_vaccination_partly(realtype *sigmay, const realtype t, const realtype *p, const realtype *k){
    ...
    sigma_ynu_countryA_vac1 = 1.0;  // sigmay[47]
    sigma_ynu_countryB_vac1 = 1.0;  // sigmay[48]
    sigma_ynu_countryA_vac2 = 1.0;  // sigmay[49]
    sigma_ynu_countryB_vac2 = 1.0;  // sigmay[50]
    sigma_yspline_countryA_vac1 = 1.0;  // sigmay[51]
    sigma_yspline_countryA_vac2 = 1.0;  // sigmay[52]
    sigma_ycountryA = 1.0;  // sigmay[53]
    sigma_ycountryB = 1.0;  // sigmay[54]
}
