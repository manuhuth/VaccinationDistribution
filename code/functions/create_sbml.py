...
def create_sbml_file(
    ...
    if splines is not None:
        ...
        for keys in spline_identifier:
            create_cubic_hermite_spline(
                model=model, parameter_name=keys, **splines[keys]
            )
...
def create_cubic_hermite_spline(
    model, parameter_name, time_symbol, xx, yy, xx_names, yy_names
):
