...
def get_extension() -> Extension:
    ...
    sources = [os.path.join("swig", "tmpif24ue8s.i"), *get_model_sources()]
    ...
    # Build shared object
    ext = Extension(
        'tmpif24ue8s._tmpif24ue8s',
        sources=sources,
        include_dirs=ext_include_dirs,
        libraries=libraries,
        library_dirs=ext_library_dirs,
        swig_opts=[
            '-c++', '-modern', '-outdir', 'tmpif24ue8s',
...
setup(
    ...
    cmdclass=CMDCLASS,
    version='0.1.0',
    description='AMICI-generated module for model tmpif24ue8s',
