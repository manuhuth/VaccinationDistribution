...
/*-----------------------------------------------
              @(target):= _vaccination_neural_network.so
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__vaccination_neural_network

#else
#  define SWIG_init    init_vaccination_neural_network

#endif
#define SWIG_name    "_vaccination_neural_network"
