...
def get_extension() -> Extension:
    ...
    sources = [os.path.join("swig", "one_country.i"), *get_model_sources()]
    ...
    # Build shared object
    ext = Extension(
        'one_country._one_country',
        sources=sources,
        include_dirs=ext_include_dirs,
        libraries=libraries,
        library_dirs=ext_library_dirs,
        swig_opts=[
            '-c++', '-modern', '-outdir', 'one_country',
...
setup(
    ...
    cmdclass=CMDCLASS,
    version='0.1.0',
    description='AMICI-generated module for model one_country',
