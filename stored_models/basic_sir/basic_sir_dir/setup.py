...
def get_extension() -> Extension:
    ...
    sources = [os.path.join("swig", "basic_sir.i"), *get_model_sources()]
    ...
    # Build shared object
    ext = Extension(
        'basic_sir._basic_sir',
        sources=sources,
        include_dirs=ext_include_dirs,
        libraries=libraries,
        library_dirs=ext_library_dirs,
        swig_opts=[
            '-c++', '-modern', '-outdir', 'basic_sir',
...
setup(
    ...
    cmdclass=CMDCLASS,
    version='0.1.0',
    description='AMICI-generated module for model basic_sir',
