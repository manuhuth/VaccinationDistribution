...
std::array<const char*, 62> parameterNames = {
    "lambda1", // p[0]
"p", // p[1]
"gamma", // p[2]
"beta", // p[3]
...
"proportion_par_countryA_vac1_0", // p[60]
"proportion_par_countryA_vac1_200", // p[61]
};
...
"proportion_countryA_vac1", // y[2]
"proportion_countryB_vac1", // y[3]
"t", // y[4]
};

std::array<const char*, 114> expressionNames = {
    "proportion_countryB_vac1", // w[0]
"proportion_countryA_vac1", // w[1]
"nu_countryB_vac2", // w[2]
"nu_countryA_vac2", // w[3]
"nu_countryA_vac1", // w[4]
"nu_countryB_vac1", // w[5]
"flux_r0", // w[6]
"flux_r1", // w[7]
"flux_r2", // w[8]
"flux_r3", // w[9]
...
std::array<const char*, 62> parameterIds = {
    "lambda1", // p[0]
"amici_p", // p[1]
"gamma", // p[2]
"beta", // p[3]
...
"observable_proportion_countryA_vac1", // y[2]
"observable_proportion_countryB_vac1", // y[3]
"observable_time", // y[4]
};

std::array<const char*, 114> expressionIds = {
    "proportion_countryB_vac1", // w[0]
"proportion_countryA_vac1", // w[1]
"nu_countryB_vac2", // w[2]
"nu_countryA_vac2", // w[3]
