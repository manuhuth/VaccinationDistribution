...
def run_model_stepwise_vaccines_pyPesto(
    theta,
    model,
    solver,
    set_start_parameter,
...
def run_model_stepwise_vaccines_sum_pyPesto(
    theta,
    model,
    solver,
    set_start_parameter,
    ...
    -------
    sum_states : float
        Sum of states with value as key such that function can
        be used by estimagic.

    """
    trajectory_dict = run_model_stepwise_vaccines_pyPesto(
        theta,
        model,
        solver,
        set_start_parameter,
