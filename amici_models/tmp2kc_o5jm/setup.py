...
def get_extension() -> Extension:
    ...
    sources = [os.path.join("swig", "tmp2kc_o5jm.i"), *get_model_sources()]
    ...
    # Build shared object
    ext = Extension(
        'tmp2kc_o5jm._tmp2kc_o5jm',
        sources=sources,
        include_dirs=ext_include_dirs,
        libraries=libraries,
        library_dirs=ext_library_dirs,
        swig_opts=[
            '-c++', '-modern', '-outdir', 'tmp2kc_o5jm',
...
setup(
    ...
    cmdclass=CMDCLASS,
    version='0.1.0',
    description='AMICI-generated module for model tmp2kc_o5jm',
